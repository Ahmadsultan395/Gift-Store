...
export async function POST(request) {
  try {
    ...
    const {
      ...
      purchasePrice, sellingPrice, oldPrice, discountPrice,
      stock, unit, weight, expiryDate, status,
      isFeatured, isNewArrival, isFlashSale,
      tags, images, lowStockThreshold,
      seo,
    } = body;
    ...
    if (oldPrice && oldPrice > sellingPrice) {
      discountPercent = Math.round(((oldPrice - sellingPrice) / oldPrice) * 100);
    }
